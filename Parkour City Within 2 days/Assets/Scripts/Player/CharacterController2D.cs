...
public class CharacterController2D : MonoBehaviour
{
    ...
    public GameObject hand;      // A collider that will be disabled when crouching
    ...
    private void FixedUpdate()
    {
        ...
        for (int i = 0; i < Mathf.Max(colliders.Length, colliders2.Length); i++)
        {
    ...
    public void Flip()
    {
        ...
        Vector3 weaponLocalScale = transform.Find("WeaponHolder").localScale;
        weaponLocalScale.x *= -1f;
        weaponLocalScale.y *= -1f;
        transform.Find("WeaponHolder").localScale = weaponLocalScale;
    }
}